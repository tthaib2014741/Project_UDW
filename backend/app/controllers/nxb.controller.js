const ContactService = require("../services/nxb.services");
...
exports.create = async (req, res, next) => {
    ...
    try {
        ...
        return res.status(200).send({ message: "Nha xuat ban tao thanh cong", createdContact: document });
    } catch (error) {
        console.log(error);
...
exports.delete = async (req, res, next) => {
    try {
        ...
        return res.send({ message: "nxb deleted successfully" });
