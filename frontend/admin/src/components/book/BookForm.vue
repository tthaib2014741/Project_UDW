<template>
  <Form @submit="submitContact" :validation-schema="contactFormSchema">
    <div class="form-group">
      ...
      <Field name="TENSACH" type="text" class="form-control" v-if="BookLocal && BookLocal._id"
        v-model="BookLocal.TENSACH" />
      <Field name="TENSACH" type="text" class="form-control" placeholder=" Nhập tên" v-else
        @input="updateContact('TENSACH', $event.target.value)"></Field>
      <ErrorMessage name="TENSACH" class="error-feedback" />
    </div>
    <div class="form-group">
      <label for="DONGIA">Đơn giá</label>
      <Field name="DONGIA" type="text" class="form-control" v-if="BookLocal && BookLocal._id"
        v-model="BookLocal.DONGIA" />
      <Field name="DONGIA" type="text" class="form-control" placeholder=" Nhập đơn giá" v-else
        @input="updateContact('DONGIA', $event.target.value)"></Field>
      <ErrorMessage name="DONGIA" class="error-feedback" />
    </div>
    <div class="form-group">
      <label for="SOQUYEN">Số quyển</label>
      <Field name="SOQUYEN" type="number" class="form-control" v-if="BookLocal && BookLocal._id"
        v-model="BookLocal.SOQUYEN" />
      <Field name="SOQUYEN" type="number" class="form-control" placeholder=" Nhập số quyển" v-else
        @input="updateContact('SOQUYEN', $event.target.value)"></Field>
      <ErrorMessage name="SOQUYEN" class="error-feedback" />
    </div>
    <div class="form-group">
      <label for="NAMXUATBAN">Năm xuất bản</label>
      <Field name="NAMXUATBAN" type="text" class="form-control" v-if="BookLocal && BookLocal._id"
        v-model="BookLocal.NAMXUATBAN" />
      <Field name="NAMXUATBAN" type="text" class="form-control" placeholder=" Nhập năm xuất bản" v-else
        @input="updateContact('NAMXUATBAN', $event.target.value)"></Field>
    ...
    <div class="form-group">
      ...
      <Field name="TACGIA" type="text" class="form-control" v-if="BookLocal && BookLocal._id"
        v-model="BookLocal.TACGIA" />
      <Field name="TACGIA" type="text" class="form-control" placeholder="Tác giả" v-else
        @input="updateContact('TACGIA', $event.target.value)"></Field>
